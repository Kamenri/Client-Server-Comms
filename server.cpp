...
void process_newchannel_request (RequestChannel *_channel)
{
	...
	if (ival == "f") 
		data_channel = new FIFORequestChannel (new_channel_name, RequestChannel::SERVER_SIDE, buffercapacity);
	else if (ival == "q")
...
int main(int argc, char *argv[])
{
	...
	cout << "** server bufferCapacity = " << buffercapacity << endl;
	cout << "** server ival = [" << ival << "]" << endl;
	...
	if (ival == "f")
		control_channel = new FIFORequestChannel ("control", RequestChannel::SERVER_SIDE, buffercapacity);
	else if (ival == "q")
